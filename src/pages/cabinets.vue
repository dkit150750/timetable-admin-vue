<template>
	<ContentWrapper title="Кабинеты">
		<div class="data__add-item">
			<ContentForm label="Кабинет" :errors="errors" @submitForm="addItemHandler" @blurInput="validate" />
		</div>
...
const getData = Content.getDataDecorator(CabinetService, data, lastPage);
...
const addItem = Content.addItemDecorator(CabinetService, data, validate, errors);
...
const updateItem = Content.updateItemDecorator(CabinetService, data, 1);
...
const deleteItem = Content.deleteItemDecorator(CabinetService);
