<template>
	<ContentWrapper title="Дисциплины">
		<div class="data__add-item">
			<ContentForm label="Дисциплина" :errors="errors" @submitForm="addItemHandler" @blurInput="validate" />
		</div>
...
const getData = Content.getDataDecorator(DisciplineService, data, lastPage);
...
const addItem = Content.addItemDecorator(DisciplineService, data, validate, errors);
...
const updateItem = Content.updateItemDecorator(DisciplineService, data, 1);
...
const deleteItem = Content.deleteItemDecorator(DisciplineService);
